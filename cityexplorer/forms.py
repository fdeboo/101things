...
class CreateSuggestionForm(FlaskForm):
    ...
    suggestion = StringField('Suggestion', validators=[InputRequired(), Length(min=2, max=70)])
    category = SelectField('Category', validators=[DataRequired()], choices=[('', 'Select'), ('Museums', 'Museums'), ('Nature & Parks', 'Nature & Parks'), ('Shopping', 'Shopping'), ('Foodie Hotspots', 'Foodie Hotspots'), ('Restaurants & Bars', 'Restaurants & Bars'), ('Tourist Landmarks', 'Tourist Landmarks'), ('Theme Parks', 'Theme Parks'), ('Accommodation', 'Accommodation'), ('Theatre & Shows', 'Theatre & Shows'), ('Skyscraper', 'Skyscraper'), ('Vineyards', 'Vineyards'), ('Zoo & Aquariums', 'Zoos & Aquariums'), ('Attractions', 'Attractions'), ('PLaces of Worship', 'Places of Worship'), ('Plazas', 'Plazas'), ('Tour Groups', 'Tour Groups')], default="default")
    cost = SelectField('Cost Per Person', choices=[('', 'Select'), ('Free', 'Free'), ('Less than £10', 'Less than £10'), ('£10-20', '£10-£20'), ('£20-50', '£20-£50'), ('More than £50', 'Over £50')])
