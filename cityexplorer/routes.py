...
from cityexplorer.forms import RegistrationForm, LoginForm, UpdateAccountForm, RequestResetForm, ResetPasswordForm, CreateLocationForm, CreateSuggestionForm, SearchLocationForm
...
def index():
    ...
    if form.validate_on_submit():
        ...
        return render_template('home.html', locations=query, searched=searched, form=form, title="Home")
    query = cities.find({})
